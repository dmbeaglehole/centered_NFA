...
for SEED in [0,1,2]:
    dW_path = os.path.join(results_path, f'mlp_dWs_{dataset}_n_{n}_lr_{LR}_epochs_{epochs}_width_{width}_seed_{SEED}.pt')
    loss_path = os.path.join(results_path, f'mlp_losses_{dataset}_n_{n}_lr_{LR}_epochs_{epochs}_width_{width}_seed_{SEED}.pt')
...
save_to_csv(nfa_mean, f'mlp_{dataset}_n_{n}_lr_{LR}_epochs_{epochs}_width_{width}_nfa_mean.csv')
save_to_csv(cnfa_mean, f'mlp_{dataset}_n_{n}_lr_{LR}_epochs_{epochs}_width_{width}_cnfa_mean.csv')
save_to_csv(nfa_std, f'mlp_{dataset}_n_{n}_lr_{LR}_epochs_{epochs}_width_{width}_nfa_std.csv')
save_to_csv(cnfa_std, f'mlp_{dataset}_n_{n}_lr_{LR}_epochs_{epochs}_width_{width}_cnfa_std.csv')

loss_fig_title = os.path.join(save_path, f'mlp_losses_{dataset}_all_seeds.pdf')
...
nfa_fig_title = os.path.join(save_path, f'mlp_nfas_{dataset}_all_seeds.pdf')
...
axes[0].set_yticks(torch.linspace(0,1,11))
